...
gbt = GBTRegressor(featuresCol = 'features', labelCol = 'i_total_amount',maxIter=25,maxDepth =5)
#cvModel = crossval.fit(df_train)
gbtModel = gbt.fit(dataset)
gbt_result = gbtModel.transform(dataset)
gbt_result_e = gbtModel.transform(dataset_e)

gbt_result_e.show()
result = gbt_result_e.select(['i_total_amount','prediction'])
result.show()
gbtModel.write().overwrite().save("./GBT_25iter_5depth-model_0")
