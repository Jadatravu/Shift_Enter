...
gbt = GBTRegressor(featuresCol = 'features', labelCol = 'fare_amount', maxIter=20)
gbt_model = gbt.fit(vhouse_df)
gbt_model.write().overwrite().save("./spark-ml-30_6vm-derived-GBT-model")
